		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#DeveloperTest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DeveloperTest-display": {
								"semanticObject": "DeveloperTest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bournedigital.orders",
									"url": sap.ui.require.toUrl("bournedigital/orders")
								}
							}
						}
					}
