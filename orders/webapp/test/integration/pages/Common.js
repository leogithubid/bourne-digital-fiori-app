sap.ui.define([
	...
	return Opa5.extend("bournedigital.orders.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["bournedigital/orders/localService/mockserver"], function (mockserver) {
